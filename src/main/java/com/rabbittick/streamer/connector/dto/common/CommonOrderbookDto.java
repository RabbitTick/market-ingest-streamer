 ...
 * <p>주요 책임:
 * <ul>
 *   <li>WebSocket API의 orderbook 메시지 역직렬화</li>
...
public class CommonOrderbookDto {
	 ...
	 * 총 매도 잔량.
	 *
	 * <p>WebSocket API 필드: tas (total_ask_size)
	 */
	@JsonProperty("tas")
	 ...
	 * 총 매수 잔량.
	 *
	 * <p>WebSocket API 필드: tbs (total_bid_size)
	 */
	@JsonProperty("tbs")
	 ...
	 * 호가 정보 목록.
	 *
	 * <p>WebSocket API 필드: obu (orderbook_units)
	 */
	@JsonProperty("obu")
	...
	public static class OrderbookUnit {
		 ...
		 * 매도 호가 가격.
		 *
		 * <p>WebSocket API 필드: ap (ask_price)
		 */
		@JsonProperty("ap")
		 ...
		 * 매도 호가 수량.
		 *
		 * <p>WebSocket API 필드: as (ask_size)
		 */
		@JsonProperty("as")
		 ...
		 * 매수 호가 가격.
		 *
		 * <p>WebSocket API 필드: bp (bid_price)
		 */
		@JsonProperty("bp")
		 ...
		 * 매수 호가 수량.
		 *
		 * <p>WebSocket API 필드: bs (bid_size)
		 */
		@JsonProperty("bs")
