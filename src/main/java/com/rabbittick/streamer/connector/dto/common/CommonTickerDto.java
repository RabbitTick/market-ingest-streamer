...
/**
 * WebSocket Ticker 응답 데이터를 담는 공통 DTO 클래스.
 *
 * <p>주요 책임:
 * <ul>
 *   <li>WebSocket API의 ticker 메시지 역직렬화</li>
...
public class CommonTickerDto {
	 ...
	 * 시가 (당일 첫 거래가).
	 *
	 * <p>WebSocket API 필드: op (opening_price)
	 */
	@JsonProperty("op")
	 ...
	 * 고가 (당일 최고가).
	 *
	 * <p>WebSocket API 필드: hp (high_price)
	 */
	@JsonProperty("hp")
	 ...
	 * 저가 (당일 최저가).
	 *
	 * <p>WebSocket API 필드: lp (low_price)
	 */
	@JsonProperty("lp")
	 ...
	 * 24시간 누적 거래대금.
	 *
	 * <p>WebSocket API 필드: atp24h (acc_trade_price_24h)
	 */
	@JsonProperty("atp24h")
	 ...
	 * 24시간 누적 거래량.
	 *
	 * <p>WebSocket API 필드: atv24h (acc_trade_volume_24h)
	 */
	@JsonProperty("atv24h")
