...
/**
 * WebSocket Trade 응답 데이터를 담는 공통 DTO 클래스.
 *
 * <p>주요 책임:
 * <ul>
 *   <li>WebSocket API의 trade 메시지 역직렬화</li>
 *   <li>외부 API 응답과 내부 시스템 간의 데이터 격리</li>
 *   <li>JSON 필드명과 Java 필드명 간의 매핑</li>
 *   <li>입력 데이터의 기본적인 유효성 검증</li>
 * </ul>
 *
 * <p>필드 포맷이 다른 거래소는 {@code connector/dto/{거래소명}/} 아래에 전용 DTO를 추가한다.
 */
@Data
@NoArgsConstructor
...
public class CommonTradeDto {
     ...
     *
     * <p>WebSocket API 필드: tms (timestamp)
     */
    @JsonProperty("tms")
     ...
     * 거래일 (yyyy-MM-dd 형식).
     *
     * <p>WebSocket API 필드: td (trade_date)
     */
    @JsonProperty("td")
     ...
     * 거래시각 (HH:mm:ss 형식).
     *
     * <p>WebSocket API 필드: ttm (trade_time)
     */
    @JsonProperty("ttm")
     ...
     *
     * <p>WebSocket API 필드: ttms (trade_timestamp)
     */
    @JsonProperty("ttms")
     ...
     * 체결 가격 (단위: 원 또는 해당 화폐).
     *
     * <p>WebSocket API 필드: tp (trade_price)
     */
    @JsonProperty("tp")
     ...
     * 체결량.
     *
     * <p>WebSocket API 필드: tv (trade_volume)
     */
    @JsonProperty("tv")
     ...
     * 전일 종가.
     *
     * <p>WebSocket API 필드: pcp (prev_closing_price)
     */
    @JsonProperty("pcp")
     ...
     * 변화 금액 (전일 종가 대비).
     *
     * <p>WebSocket API 필드: cp (change_price)
     */
    @JsonProperty("cp")
     ...
     * 체결 고유 ID.
     *
     * <p>WebSocket API 필드: sid (sequential_id)
     */
    @JsonProperty("sid")
     ...
     * 최우선 매도호가.
     *
     * <p>WebSocket API 필드: bap (best_ask_price)
     */
    @JsonProperty("bap")
     ...
     * 최우선 매도호가 수량.
     *
     * <p>WebSocket API 필드: bas (best_ask_size)
     */
    @JsonProperty("bas")
     ...
     * 최우선 매수호가.
     *
     * <p>WebSocket API 필드: bbp (best_bid_price)
     */
    @JsonProperty("bbp")
     ...
     * 최우선 매수호가 수량.
     *
     * <p>WebSocket API 필드: bbs (best_bid_size)
     */
    @JsonProperty("bbs")
     ...
     * 스트림 타입.
     *
     * <p>WebSocket API 필드: st (stream_type)
     */
    @JsonProperty("st")
