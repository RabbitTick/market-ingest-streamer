...
@DisplayName("CommonTickerDto Validation 테스트")
class CommonTickerDtoValidationTest {
	...
	void validData_shouldPassValidation() {
		// given
		CommonTickerDto dto = createValidDto();

		// when
		Set<ConstraintViolation<CommonTickerDto>> violations = validator.validate(dto);
	...
	private CommonTickerDto createValidDto() {
		CommonTickerDto dto = new CommonTickerDto();
