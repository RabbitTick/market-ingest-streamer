...
@DisplayName("CommonTradeDto Validation 테스트")
class CommonTradeDtoValidationTest {
	...
	void validData_shouldPassValidation() {
		// given
		CommonTradeDto dto = createValidDto();

		// when
		Set<ConstraintViolation<CommonTradeDto>> violations = validator.validate(dto);
	...
	private CommonTradeDto createValidDto() {
		CommonTradeDto dto = new CommonTradeDto();
